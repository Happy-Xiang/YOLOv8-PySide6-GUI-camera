...
"}")
        ...
        # ------------------------------------------------------- 侧边栏
        self.logo.setStyleSheet(u"image: url(:/all/img/model.png);\n"
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"By 雯鑫", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"智能识别", None))
        ...
        self.src_cam_button.setText(QCoreApplication.translate("MainWindow", u"摄像机", None))
        self.src_rtsp_button.setText(QCoreApplication.translate("MainWindow", u"其他", None))
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"Version: 1.0", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"智能识别", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"侦测值", None))
        ...
        self.ToggleBotton_6.setText(QCoreApplication.translate("MainWindow", u"选择模型", None))
        self.model_box.setPlaceholderText("")
        self.ToggleBotton_2.setText(QCoreApplication.translate("MainWindow", u"标准(IOU)", None))
        self.ToggleBotton_3.setText(QCoreApplication.translate("MainWindow", u"配置(Conf)", None))
        self.ToggleBotton_4.setText(QCoreApplication.translate("MainWindow", u"延时(ms)", None))
        self.ToggleBotton_5.setText(QCoreApplication.translate("MainWindow", u"保存(Save)", None))
